...
def main():
    parser = argparse.ArgumentParser(description='MAPF-GPT Decentralized Safe Action Wrapper')
    ...
    parser.add_argument('--priority_scheme', type=str, choices=['index', 'random'], default='index',
